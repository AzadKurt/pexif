 ...
 * Returns 0 if the image constitued by the bytes array does not contain an exif marker.
 */
long validate_exif_sig(long byte_count, BYTE img_bytes[]);

/**
 * Given a file name file_name of an image that has been pexifed, returns "pexif_" + file_name.    
 */
